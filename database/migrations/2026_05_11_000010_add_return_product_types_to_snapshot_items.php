...
return new class extends Migration {
    public function up(): void
    {
        Schema::table('period_snapshot_items', function (Blueprint $table) {
            $table->enum('type', [
                'customer', 'supplier', 'product_stock', 'opening_stock', 'payment_method',
                'waste_product', 'purchased_product', 'sold_product',
                'customer_return_product', 'supplier_return_product',
