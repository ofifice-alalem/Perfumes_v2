...
interface ReportRepositoryInterface
{
    ...
    public function sales(?string $dateFrom, ?string $dateTo, ?int $userId, ?int $customerId, ?int $paymentMethodId, ?int $categoryId, bool $compare, ?string $searchName = null): array;
    ...
    public function purchases(?string $dateFrom, ?string $dateTo, ?int $userId, ?int $supplierId, ?int $categoryId, bool $compare, ?string $searchName = null): array;
