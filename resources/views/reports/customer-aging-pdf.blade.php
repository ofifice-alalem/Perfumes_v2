...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Cairo', 'DejaVu Sans', sans-serif; }
        ...
        table.main td.idx  { color: #64748b; font-size: 10px; text-align: center; }
        ...
        table.invoices { width: 92%; border-collapse: collapse; direction: ltr; margin: 0 0 8px 8%; }
        ...
        table.invoices td.inv-ref { color: #3b82f6; font-weight: bold; }
        table.invoices td.over90  { color: #dc2626; font-weight: bold; }
        table.invoices td.warn    { color: #d97706; font-weight: bold; }
    ...
    <table style="width: 80%; border-collapse: collapse; direction: rtl; margin: 12px auto 0; border: 2px solid #0f172a;">
        ...
        <tr>
            ...
            <td style="padding: 16px 8px; text-align: center; background: #f8fafc;">
                ...
                <div style="font-size: 20px; font-weight: bold; color: #0f172a;">{{ $labels['customers_count'] }}</div>
            </td>
        </tr>
    </table>
...
<div class="summary-tbl">
    ...
    <div class="summary-cell">
        ...
        <div class="summary-value">{{ $labels['customers_count'] }}</div>
    </div>
</div>
...
<table class="main">
    <thead>
        <tr>
            ...
            <th style="width:13%">{{ $labels['col_total'] }}</th>
            ...
            <td colspan="8" style="padding: 0; border: none; background: #fff;">
                <table class="invoices">
                    ...
                    <tr>
                        ...
                        <td class="num" style="width:18%">{{ $fmtN($inv['due']) }}</td>
                        <td class="{{ $inv['days_old'] >= 90 ? 'over90' : ($inv['days_old'] >= 30 ? 'warn' : '') }}" style="width:15%">{{ $inv['days_old'] }} {{ $g('يوم') }}</td>
                        <td style="width:34%; color:#94a3b8;">{{ $g('إجمالي') }}: {{ $fmtN($inv['total']) }} | {{ $g('مدفوع') }}: {{ $fmtN($inv['paid']) }}</td>
                    </tr>
                    @endforeach
                </table>
            </td>
    ...
    <tfoot>
        <tr>
            <td colspan="2" style="text-align: right; color: #64748b;">{{ $g('الإجمالي') }}</td>
