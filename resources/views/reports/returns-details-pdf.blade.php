...
<table class="items">
    <thead>
        <tr>
            ...
            <th style="width:13%">{{ $labels['qty'] }}</th>
            <th style="width:33%">{{ $labels['product'] }}</th>
    ...
    <tbody>
        ...
        <tr class="{{ $i % 2 === 0 ? '' : 'even' }}">
            ...
            <td class="num">{{ $item['size_label'] ?? '—' }}</td>
            <td>{{ $item['product_name'] }}</td>
            <td class="num" style="color:#1565C0; font-weight:bold;">{{ $item['count'] }}</td>
        </tr>
        @endforeach
    </tbody>
</table>
...
<div class="footer">
    <div class="footer-line1">
        ...
        <span style="font-weight: bold; color: #0f172a;">{{ $labels['title'] }} &mdash; {{ $labels['type_label'] }}</span>
    </div>
