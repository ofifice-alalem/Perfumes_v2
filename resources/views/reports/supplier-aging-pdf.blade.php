...
{{-- جدول العملاء --}}
@php
    $typeLabels = ['purchase' => 'شراء', 'payment' => 'دفعة', 'settlement' => 'تسوية', 'return' => 'مرتجع', 'opening_balance' => 'رصيد سابق'];
    $typeColors = ['purchase' => '#334155', 'payment' => '#16a34a', 'settlement' => '#3b82f6', 'return' => '#d97706', 'opening_balance' => '#9333ea'];
@endphp
