        ...
        <>
            {trigger ? (
                ...
                <button
                    ...
                    className={triggerClassName ?? 'flex items-center justify-center gap-1.5 px-4 h-9 rounded-[14px] border border-emerald-500/30 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500 hover:text-white hover:border-emerald-500 transition-all duration-200 font-bold text-sm'}
                >
                ...
                <div className="fixed inset-0 z-[1000] flex items-end sm:items-center justify-center p-4">
                    ...
                    <div className="relative w-full sm:max-w-sm rounded-[28px] p-6 flex flex-col gap-5 animate-in fade-in zoom-in-95 duration-200
                        ...
                        <div className="flex items-center justify-between">
                            <div className="w-12 h-12 rounded-[16px] bg-emerald-500/12 border border-emerald-500/15 flex items-center justify-center">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button
                                ...
                                className="flex-1 h-11 rounded-[14px] bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-sm transition-all flex items-center justify-center gap-2 shadow-sm shadow-emerald-500/30"
                            >
