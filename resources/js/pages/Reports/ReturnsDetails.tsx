                                                            ...
                                                            <table className="w-full text-[16px]">
                                                                <thead>
                                                                    <tr className="border-b border-black/5 dark:border-white/5">
                                                                        <th className="text-right py-2 px-3 text-sm font-black text-slate-400 dark:text-white/30">رقم المرتجع</th>
                                                                ...
                                                                <tbody className="divide-y divide-black/5 dark:divide-white/5">
                                                                    {entity.returns.map(r => (
                                                                        <>
                                                                            <tr key={r.id} className="hover:bg-primary/5 dark:hover:bg-primary/20 cursor-pointer group transition-colors">
                                                                            ...
                                                                            {expandedReturns.has(r.id) && (
                                                                                <tr key={`${r.id}-items`}>
                                                                                    <td colSpan={4} className="px-4 pt-1 pb-3 bg-black/2 dark:bg-white/2">
                                                                                        <div className="hidden sm:grid grid-cols-[60px_2fr_70px_80px_90px] gap-2 px-3 py-2 text-xs font-bold text-slate-500 dark:text-white/40 bg-slate-50 dark:bg-slate-800/50 rounded-[10px] border border-slate-200/50 dark:border-slate-700/50 mb-1.5">
                                                                                        ...
                                                                                        <div className="flex flex-col gap-1.5">
                                                                                            {r.items.map((item, i) => (
                                                                                                <div key={i}>
                                                                                                    <div className="hidden sm:grid grid-cols-[60px_2fr_70px_80px_90px] gap-2 px-3 py-2.5 rounded-[12px] bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-primary/30 transition-all shadow-sm">
                                                                                                        <div className="flex items-center justify-center">
                                                                                                            <span className="w-9 h-8 rounded-[8px] flex items-center justify-center font-black text-sm bg-primary/10 text-primary">{item.count}</span>
                                                                                                        </div>
                                                                                                        ...
                                                                                                        <div className="flex items-center justify-center">
                                                                                                            {item.size_label
                                                                                                                ? <span className="text-xs font-black text-white bg-primary px-2 py-1 rounded-full">{item.size_label}</span>
                                                                                                    ...
                                                                                                    <div className="sm:hidden flex items-center gap-2 p-2.5 rounded-[12px] bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm">
                                                                                                        <span className="w-9 h-9 rounded-[8px] flex items-center justify-center font-black text-sm shrink-0 bg-primary/10 text-primary">{item.count}</span>
                                                                                                        <div className="flex-1 min-w-0">
                                                                                                            <p className="font-bold text-slate-800 dark:text-white text-xs truncate">{item.product_name}</p>
                                                                                                            <div className="flex items-center gap-2 mt-0.5">
                                                                                                                {item.size_label && <span className="text-[10px] font-black text-white bg-primary px-1.5 py-0.5 rounded-full">{item.size_label}</span>}
