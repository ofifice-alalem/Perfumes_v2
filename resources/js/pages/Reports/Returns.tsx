                    ...
                    <table className="w-full text-sm">
                        <thead>
                            <tr className={headerCls}>
                                {['الشهر', 'عدد', 'الإجمالي', ''].map(h => (
                                    <th key={h} className="text-right px-4 py-3 text-xs font-black uppercase tracking-widest">{h}</th>
                                ))}
                            </tr>
                        </thead>
                        ...
                        <tfoot>
                            <tr className="border-t-2 border-black/10 dark:border-white/10">
                                ...
                                <td className="px-4 py-3 font-black text-slate-800 dark:text-white">{monthly.reduce((s, m) => s + m.count, 0)}</td>
