...
import { BarChart2, SlidersHorizontal, ChevronDown, Search, FileSpreadsheet, FileText } from 'lucide-react';
...
export default function InventoryCount({ categories, filters, data }: Props) {
    ...
    return (
        <AppShell pageTitle="نموذج الجرد">
            <div className="flex flex-col gap-6 pb-32 lg:pb-6">

                <div>
                    <h1 className="text-2xl font-black text-slate-800 dark:text-white">نموذج الجرد الفعلي</h1>
                    <p className="text-sm font-bold text-slate-400 dark:text-white/40 mt-1">تصدير نموذج فارغ لعمليات الجرد ومطابقة المخزون الفعلي بالمخزون النظامي</p>
                </div>
