...
export default function CustomerAging({ customers, filters, data }: Props) {
    ...
    const hasFilter = customerId || dateFrom || dateTo || showAllHistory;
                                        ...
                                        <table className="w-full text-[16px]">
                                            <thead>
                                                <tr className="bg-black/3 dark:bg-white/3 border-b border-black/5 dark:border-white/5">
                                                    {['العميل', 'إجمالي الدين', 'الحركات', ''].map(h => (
                                                    ...
                                                    <>
                                                        <tr key={c.customer_id} className="hover:bg-primary/5 dark:hover:bg-primary/20 cursor-pointer group transition-colors">
                                                            ...
                                                            <td className="px-4 py-4 text-center font-bold text-slate-500 dark:text-white/50">
                                                                {filters.customerId ? c.movements.length : '--'}
                                                            </td>
                                                            <td className="px-4 py-4">
                                                                {filters.customerId ? (
                                                                    ...
                                                                    <span className="text-xs text-slate-400">اختر عميلاً للتفاصيل</span>
                                                                )}
                                                            </td>
                                                        </tr>
                                            ...
                                            <div key={c.customer_id} className="rounded-[20px] border border-black/8 dark:border-white/12 overflow-hidden">
                                                ...
                                                <div className="px-4 py-2 flex flex-col gap-1.5 text-sm">
                                                    {filters.customerId ? (
                                                        ...
                                                        <span className="text-xs text-slate-400 mt-1">قم بفلترة التقرير برقم العميل لرؤية الحركات التفصيلية</span>
                                                    )}
