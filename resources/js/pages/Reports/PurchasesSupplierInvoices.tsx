...
import { Truck, SlidersHorizontal, ChevronDown, ChevronRight, Search, FileSpreadsheet, FileText, ArrowRight, Package, Star } from 'lucide-react';
...
export default function PurchasesSupplierInvoices({ users, suppliers, categories, products, filters, data, includedProducts }: Props) {
    ...
    const hasFilter = dateFrom || dateTo || userId || supplierId || categoryId || multiSearch.length > 0;
