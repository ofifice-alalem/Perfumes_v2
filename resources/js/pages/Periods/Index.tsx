...
export default function PeriodsIndex({ periods, currentPeriod, flash }: Props) {
    ...
    return (
        <AppShell pageTitle="الفترات المحاسبية">
            <div className="flex flex-col gap-6 pb-32 lg:pb-0">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div>
                        <h1 className="text-2xl font-black text-slate-800 dark:text-white">الفترات المحاسبية</h1>
                        <p className="text-sm font-bold text-slate-400 dark:text-white/40 mt-1">إدارة الفترات المحاسبية والتدوير</p>
                    </div>
                    {currentPeriod && (
