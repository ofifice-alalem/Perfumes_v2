                                            ...
                                            <tbody className="divide-y divide-black/5 dark:divide-white/5">
                                                {data.data.map(ret => (
                                                    <tr key={ret.id} className={`hover:bg-black/3 dark:hover:bg-white/3 transition-colors ${ret.deleted_at ? 'opacity-50' : ''}`}>
                                                        ...
                                                        <td className="px-4 py-3 text-slate-500 dark:text-white/50 whitespace-nowrap font-bold text-xs">{fmtDate(ret.created_at)}</td>
                                                        <td className="px-4 py-3">
                                            ...
                                            <div key={ret.id} className={`rounded-[24px] border border-black/8 dark:border-white/12 overflow-hidden ${ret.deleted_at ? 'opacity-60' : ''}`}>
                                                ...
                                                <div className="flex flex-col divide-y divide-black/5 dark:divide-white/8 px-5">
                                                    ...
                                                    <div className="flex items-center justify-between py-3">
                                                        ...
                                                        <span className="font-bold text-slate-500 dark:text-white/60">{fmtDate(ret.created_at)}</span>
                                                    </div>
                                                </div>
